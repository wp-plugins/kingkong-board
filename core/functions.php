    ...
    foreach($entries as $entry){
      ...
      switch($entry['value']){
        ...
        if($entry_depth > 1){
          ...
          $return_content .= "<td style='position:relative;".$reply_padding."' class='kingkongboard-list-".$entry['value']."'>".$reply_icon.$thumbnail."<a href='".get_the_permalink().kingkongboard_set_prefix()."pageid=".$pageid."&view=read&id=".$entry_id.$parent_id."'>".get_the_title($entry_id)."</a> ".$comments_count.$entry_secret_icon." ".$entry_attach_text.$mobile_writer_info."</td>";
        break;
