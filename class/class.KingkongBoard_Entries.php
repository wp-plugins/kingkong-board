<?php
  ...
  class KingkongBoard_Entries {
    ...
    function __construct($board_id){
      ...
      add_action('init', array($this, 'kingkongboard_regist_entry_post_type'));
      add_action('template_redirect', array($this, 'kingkongboard_entry_redirect'));
      add_action('admin_init', array($this, 'kingkongboard_caps'));
    }

    public function kingkongboard_caps() {
        // gets the administrator role
        $admins = get_role( 'administrator' );

        $admins->add_cap( 'edit_'.$this->board_slug ); 
        $admins->add_cap( 'edit_'.$this->board_slug.'s' ); 
        $admins->add_cap( 'edit_other_'.$this->board_slug ); 
        $admins->add_cap( 'publish_'.$this->board_slug ); 
        $admins->add_cap( 'read_'.$this->board_slug ); 
        $admins->add_cap( 'read_private_'.$this->$board_slug ); 
        $admins->add_cap( 'delete_'.$this->board_slug ); 
    }    
    ...
    public function kingkongboard_regist_entry_post_type(){
