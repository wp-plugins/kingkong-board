      ...
      if($comments){
        foreach($comments as $cmmt){
          ...
          if($comment->comment_approved == 1){
            $comment_result .= '<div class="each-comment" style="'.$depth_padding.'">';
            ...
            $comment_after = apply_filters('kingkongboard_comment_after', $entry_id, $comment->comment_ID );
            if($comment_after != $entry_id){
