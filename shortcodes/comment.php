...
function kingkong_board_comment($attr){
  ...
  $submit_button = '<a class="'.kkb_button_classer($board_id).' button-comment-save" style="display:block; line-height:0; padding:28px 0; text-align:center; margin-left:8px">'.__('확인', 'kingkongboard').'</a>';
  $commentAdd .= apply_filters('kkb_comment_submit_button', $submit_button, $board_id, $entry_id);
