<?php
  ...
  $kkbContent .= '<input type="text" name="kkb_search_keyword" value="'.$search_keyword.'">';
  $kkbContent .= '</td>';
  $kkbContent .= '<td style="text-align:left; padding-right:0">';
  $kkbContent .= '<button type="submit" class="kingkongboard-button">검색</button>';
  $kkbContent .= '</td>';
  $kkbContent .= '</tr>';
  $kkbContent .= '</table>';
  $kkbContent .= '</div>';
