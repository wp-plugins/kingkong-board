<?php
  ...
  if($sections){
    ...
    $kkbContent   .= '<td>';
    $kkbContent   .= '<select name="entry_section" value="">';
  ...
  $kkbContent .= '<a href="'.get_the_permalink().'" class="'.kkb_button_classer($board_id).' button-prev">'.__('돌아가기', 'kingkongboard').'</a> <a class="'.kkb_button_classer($board_id).' button-save">'.__('수정하기', 'kingkongboard').'</a>';
