...
if($board_skin != "basic"){
  ...
  if( file_exists(WP_CONTENT_DIR . '/'. "kingkongboard/skins/".$board_skin."/functions.php")){
    require_once(WP_CONTENT_DIR."/kingkongboard/skins/".$board_skin."/functions.php");
    wp_register_style('kkb-'.$board_skin, content_url()."/kingkongboard/skins/".$board_skin."/style.css" );
    wp_enqueue_style('kkb-'.$board_skin);
  }
        ...
        if($permission_write_status == "checked"){
          if (file_exists(TEMPLATEPATH . '/' . "kingkongboard/board-write.php")) {
            require_once(TEMPLATEPATH . "/kingkongboard/board-write.php");
              ...
              if(file_exists(WP_CONTENT_DIR . '/' . "kingkongboard/skins/".$board_skin."/board-write.php")){
                require_once(WP_CONTENT_DIR."/kingkongboard/skins/".$board_skin."/board-write.php");
              } else {
