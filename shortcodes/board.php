...
if ( is_user_logged_in() ) {
  ...
  $permission_modify_status = get_kingkongboard_permission_modify_by_role_name($board_id, $role);
  ...
  $permission_modify_status = get_kingkongboard_permission_modify_by_role_name($board_id, 'guest');
  ...
  if($board_id){
    ...
    switch($view){
      ...
      case "write" :
        $permission_write_status = apply_filters('kkb_loop_write_before', $permission_write_status, $board_id);
        if($permission_write_status == "checked"){
          ...
          return apply_filters('kkb_loop_write_denied_message', __('글 쓰기 권한이 없습니다.', 'kingkongboard'), $board_id);
        }
      break;
      ...
      case "reply" :
        ...
        if($board_reply_use == "T"){
          ...
          return apply_filters('kkb_loop_reply_denied_message', __('답글쓰기가 허용되지 않습니다.', 'kingkongboard'), $board_id);
        }
      break;
      ...
      case "read" :
        ...
        if($permission_read_status == "checked"){
          ...
          return apply_filters('kkb_loop_read_denied_message', __('글 읽기 권한이 없습니다.', 'kingkongboard'), $board_id);
        }
      break;
      ...
      default :
        $kkbContent .= apply_filters('kkb_view_redirect_after', __('잘못된 접근 입니다.', 'kingkongboard'), $view, $board_id);
      break;
    }
