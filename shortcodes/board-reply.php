<?php
  ...
  $kkbContent .= '<a href="'.get_the_permalink().'" class="'.kkb_button_classer($board_id).' button-prev">'.__('돌아가기', 'kingkongboard').'</a> <a class="'.kkb_button_classer($board_id).' button-save">'.__('저장하기', 'kingkongboard').'</a>';
