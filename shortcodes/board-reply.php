<?php
  ...
  $kkbContent .= '<a href="'.get_the_permalink().'" class="kingkongboard-button button-prev">'.__('돌아가기', 'kingkongboard').'</a> <a class="kingkongboard-button button-save">'.__('저장하기', 'kingkongboard').'</a>';
