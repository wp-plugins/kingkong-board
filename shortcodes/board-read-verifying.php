...
if(isset($_POST['view_type']) && isset($_POST['entry_id']) && isset($_POST['board_id'])){
    ...
    switch(sanitize_text_field($_GET['view'])){
        ...
        $verifyContent .= '<table class="kingkongboard-read-verifying-table"><tr><td><input type="password" name="kingkongboard-verifying-pwd"></td><td><a  class="kingkongboard-button button-verify-submit">확인</a></td></tr></table>';
        $verifyContent .= '</div>';
