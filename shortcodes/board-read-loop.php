<?php
  ...
  (isset($_GET['id'])) ? $entry_id = sanitize_text_field($_GET['id']) : $entry_id = null;
  ...
  $loopContent .= '<table id="'.$table_id.'" class="'.$table_class.'" style="margin-top:30px">';
  $loopContent .= '<thead>';
  $loopContent .= '<tr>';
  ...
  $display = $loopContent.$pageContent.$controllerContent;
  $kkbContent .= $display;
