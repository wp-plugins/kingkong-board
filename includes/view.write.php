...
?>
    <div class="write-box">
      ...
      <span class="write-span"><input type="text" id="entry-title" name="entry_title" style="width:100%" title="<?php echo apply_filters('kkb_write_title_text', __('제목', 'kingkongboard'), $this->board_id);?>"></span>
    </div>
...
?> 
    <div class="write-box check-box">
      ...
      <span class="write-span"><span class="toggle-checkbox-image"></span><input type="checkbox" id="input-checkbox-notice" class="input-checkbox" name="entry_notice" value="notice" title="<?php _e('공지사항', 'kingkongboard');?>"></span>
    </div>
    <div class="write-box-devider"></div>
<?php
...
?>
    <div class="write-box check-box">
      ...
      <span class="write-span"><span class="toggle-checkbox-image"></span><input type="checkbox" id="input-checkbox-secret" class="input-checkbox" name="entry_secret" title="<?php _e('비밀글', 'kingkongboard');?>" <?php echo $board_must_secret_text;?>> <?php echo $secret_description;?></span>
    </div> 
    <div class="write-box-devider"></div>
<?php
  ...
  $sections = apply_filters('kkb_write_sections', $config->sections, $this->board_id);
...
?>
    <div class="write-box">
      ...
      <span class="write-span"><?php echo apply_filters('kkb_write_section', '<select id="entry-section" name="entry_section" title="'.__('분류선택', 'kingkongboard').'">'.$section_value.'</select>', $this->board_id, $config->sections);?></span>
    </div>
    <div class="write-box-devider"></div>
<?php
...
?>
    <div class="write-box">
      ...
      <span class="write-span"><input type="text" id="entry-writer" name="entry_writer" title="<?php _e('작성자', 'kingkongboard');?>"></span>
    </div>
    <div class="write-box-devider"></div>
<?php
  }
...
?>
    <div class="write-box">
      ...
      <span class="write-span"><input type="password" id="entry-password" name="entry_password" title="<?php _e('비밀번호', 'kingkongboard');?>"></span>
    </div>
    <div class="write-box-devider"></div>
<?php
  }
...
<?php
  ...
  switch($config->editor){
    ...
    case "textarea" :
?>
        <textarea name="entry_content" rows="10" title="<?php _e('내용입력', 'kingkongboard');?>" placeholder="<?php echo apply_filters('kkb_write_textarea_placeholder', '', $this->board_id);?>"><?php echo $config->basicForm;?></textarea>
<?php
    break;
...
<?php
  ...
  ob_get_clean();
  echo apply_filters('kkb_write_tag_content', $tag_content, $this->board_id);
    ...
    <div class="write-box">
      ...
      <span class="write-span" style="position:relative; width:300px">
        <div class="file-upload">
          <input type="text" class="text thumbnail-file" title="<?php _e('썸네일 첨부하기', 'kingkongboard');?>" readonly="readonly" style="font-size:12px">
          <div class="upload-btn">
            ...
            <input id="entry-thumbnail" type="file" id="find" class="file" name="thumbnail_file[]" title="<?php _e('썸네일 찾아보기', 'kingkongboard');?>">
          </div>
        </div>
      </span>
    </div>
...
?>
    <div class="write-box attach-box attach-box-1">
      ...
      <span class="write-span" style="position:relative; width:300px">
        <div class="file-upload">
          <input type="text" class="text" title="<?php _e('파일 첨부하기', 'kingkongboard');?>" readonly="readonly" style="font-size:12px">
          <div class="upload-btn">
    ...
    <div class="rows-more attach-more">
      <a href="#" class="btn-attach-more" data-limit="<?php echo $attach_number;?>" data-error="<?php printf(__('최대 %d개 까지 업로드 할 수 있습니다.', 'kingkongboard'), $attach_number);?>"><?php _e('첨부파일 추가', 'kingkongboard');?></span>
    </div>
    <div class="write-box-devider"></div>
<?php
  }
