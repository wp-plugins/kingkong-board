...
?>
    <div class="write-box">
      ...
      <span class="write-span"><input type="text" name="entry_title" style="width:100%" value="Re: <?php echo $this->get_title($parent_id);?>"></span>
    </div>
...
<?php
  ...
  switch($config->editor){
    ...
    case "textarea" :
?>
        <textarea name="entry_content" rows="10"></textarea>
<?php
    break;
