...
?>
    ...
    <br><a href="?page=KingkongBoard&view=entry-reply&id=<?php echo $board_id;?><?php echo $parent_prm;?>" class="button-kkb kkbgreen"><i class="kkb-icon kkb-icon-pen"></i>답변하기</a> <a href="?page=KingkongBoard&view=entry&id=<?php echo $board;?>" class="button-kkb kkbred"><i class="kkb-icon kkb-icon-close"></i>취소</a>
  </div>
