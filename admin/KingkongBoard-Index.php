    ...
    <table class="wp-list-table widefat fixed unite_table_items">
      <thead>
        <tr>
          ...
          <th width="25%">게시판 명</th>
          <th width="120px">숏코드</th>
          <th width="100">포스트타입</th>
          <th width="70px">종류</th>
...
<?php
  ...
  if( $query->have_posts() ){
    while( $query->have_posts() ){
      ...
      $board_style      = get_post_meta($board_id, 'kingkongboard_board_style', true);
      if(!$board_style){
        $board_style = "basic";
      }
?>
        <tr>
          ...
          <td>
            <a href="?page=KingkongBoard&view=modify&id=<?php echo $board_id;?>" class="button-kkb kkbgreen"><i class="kkb-icon kkb-icon-setting"></i>옵션설정</a>
            <a href="?page=KingkongBoard&view=entry&id=<?php echo $board_id;?>" class="button-kkb kkbblue"><i class="kkb-icon kkb-icon-list"></i>리스트 보기</a>
            ...
            <a class="button-kkb kkbgray" original-title="미리보기"><i class="kkb-icon kkb-icon-preview"></i></a>-->
          </td>
        </tr>
<?php
    }
...
?>
    ...
    <div style="float:left; margin-top:10px">
      <a href="?page=KingkongBoard&view=create" class="button-kkb kkbblue">신규 게시판 생성</a>
    </div>
  </div>