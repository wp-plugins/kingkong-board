      ...
      <tr>
        ...
        <td>
          ...
          <div class="description-container">
            <span class="description">해당 숏코드의 명칭을 지정하세요.</span>
          </div>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <select class="kkb-input-select" name="kkb_shortcode_skin">
            <option value="basic">기본스타일</option>
          </select>
        </td>
      </tr>
      <tr>
        ...
        <td>
          ...
          <div class="description-container">
            <span class="description">최신글 리스트에 보여지는 게시물 수를 지정합니다.</span>
          </div>          
        </td>
      </tr>
      <tr>
        ...
        <td>
          ...
          <div class="description-container">
            <span class="description">표시될 글의 길이를 제한합니다.</span>
          </div>          
        </td>
      </tr>
      <tr>
