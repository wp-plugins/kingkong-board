...
?>
  ...
  <div class="content-area">
    <div style="padding:20px 10px">
      <div style="float:left; position:relative; top:0px; margin-right:10px">"킹콩보드는 오픈소스로 여러분들의 참여로 운영되고 있습니다. 지금 바로 기부에 참여하세요."</div> <a href="http://superrocket.io/%EA%B8%B0%EB%B6%80/" target="_blank" class="button-kkb kkborange">기부 자세히 알아보기</a>
    </div>
  </div>
...
?>
            ...
            <tr>
              ...
              <td>
                <input type="radio" name="kkb_reply_use" value="T" <?php echo $kkb_reply_use;?>>사용 <input type="radio" name="kkb_reply_use" value="F" <?php echo $kkb_reply_notuse;?>>미사용
                <div class="description-container">
