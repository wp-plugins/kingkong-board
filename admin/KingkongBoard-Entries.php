  ...
  <div class="head-area">
    ...
    <div style="float:left; font-size:18px; margin-top:14px; margin-left:20px">게시판 글목록 : <?php echo get_the_title($board_id);?></div>
...
?>
    ...
    <div style="float:right; margin-right:5px; padding-bottom:5px">등록된 총 글 수 : <span style="background:#616161; color:#fff; border-radius:10px; padding:0 5px"><?php echo $KingkongEntries->entry_count;?></span></div>
...
?>
 ...
 <?php 
  ...
  ?>
    ...
    <br><a href="?page=KingkongBoard&view=entry-write&id=<?php echo $board_id;?>" class="button-kkb kkbblue"><i class="kkb-icon kkb-icon-pen"></i>글 쓰기</a> <a href="?page=KingkongBoard&view=modify&id=<?php echo $board_id;?>" class="button-kkb kkbgreen"><i class="kkb-icon kkb-icon-setting"></i>게시판 옵션설정</a> <a href="?page=KingkongBoard" class="button-kkb kkbred">이전으로</a>
  </div>