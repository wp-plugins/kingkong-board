...
<?php
  ...
  foreach( $roles as $role_name => $role_info ){
    if($board_id){
      ...
      $permission_modify  = get_kingkongboard_permission_modify_by_role_name($board_id, $role_name);
    } else {
      $permission_read    = "checked";
      $permission_write   = "checked";
      $permission_delete  = "checked";
      $permission_modify  = "checked";
    }
?>
            <tr>
              ...
              <td><input type="checkbox" name="permission_modify[]" value="<?php echo $role_name;?>" <?php echo $permission_modify;?>></td>
...
<?php
  ...
  if($board_id){
    ...
    $guest_permission_modify  = get_kingkongboard_permission_modify_by_role_name($board_id, 'guest');
  } else {
    $guest_permission_read    = "checked";
    $guest_permission_write   = "checked";
    $guest_permission_delete  = "checked";
    $guest_permission_modify  = "checked";
  }
?>
            <tr>
              ...
              <td><input type="checkbox" name="permission_modify[]" value="guest" <?php echo $guest_permission_modify;?>></td>
