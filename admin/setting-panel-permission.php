    ...
    <table>
      <tr>
        ...
        <td>
          ...
          <button type="button" class="kkb-icon kkbblue button-add-manager"><i class="kkb-icon kkb-icon-plus" style="position:relative; top:3px"></i>추가하기</button>
          <div class="description-container">
            <span class="description">사용자 아이디를 입력하세요, 콤마(,)로 구분.</span>
          </div>       
