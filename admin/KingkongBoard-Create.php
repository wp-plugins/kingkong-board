...
?>
            ...
            <tr>
              ...
              <td>
                <input type="checkbox" name="kkb_must_section" value="T"> <?php _e('분류 반드시 선택', 'kingkongboard');?>
                <div class="description-container" style="margin-bottom:10px">
                  <span class="description"><?php _e('분류가 있다면 반드시 선택해야만 글이 등록 됩니다.', 'kingkongboard');?></span>
                </div>  
                <input type="checkbox" name="kkb_must_secret" value="T"> <?php echo __('전체 게시글 비밀글로 설정', 'kingkongboard');?>
                <div class="description-container">
                  <span class="description"><?php _e('비밀글 설정 여부에 상관없이 모든 글들이 비밀글로 등록 됩니다.', 'kingkongboard');?></span>
                </div>
                <input type="checkbox" name="kkb_must_thumbnail" value="T"> <?php echo __('썸네일 반드시 등록', 'kingkongboard');?>
                <div class="description-container">
                  <span class="description"><?php _e('썸네일을 반드시 업로드 해야만 글이 등록 됩니다.', 'kingkongboard');?></span>
                </div> 
              </td> 
            </tr>
            <tr>
              ...
              <td>
                <input type="checkbox" name="kkb_read_under_loop" value="T"> <?php _e('현재 페이지 리스트를 표시', 'kingkongboard');?>
                <div class="description-container" style="margin-bottom:10px">
            ...
            <tr>
              ...
              <td>
                <input type="text" class="kkb-input" name="kkb_attach_number" value="1">
                <div class="description-container">
            ...
            <tr>
              ...
              <td>
                <input type="checkbox" name="kkb_auto_url" value="T"> <?php echo __('본문에 URL 기입시 자동으로 하이퍼링크를 붙입니다.', 'kingkongboard');?>
                <div class="description-container">
